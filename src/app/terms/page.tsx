      ...
      <div className="container mx-auto max-w-3xl px-4 py-8">
        <Card>
          ...
          <CardContent className="space-y-4 text-muted-foreground">
            ...
            <p>
              باستخدامك لمنصة "وظيفتك"، فإنك توافق على الالتزام بشروط الاستخدام هذه. إذا كنت لا توافق على هذه الشروط، فيجب عليك عدم استخدام المنصة.
            </p>
            ...
            <p>
              "وظيفتك" هي منصة وسيطة لتسهيل التواصل بين المستخدمين. نحن لا نضمن صحة الإعلانات أو جودة الخدمات المقدمة، ولسنا طرفًا في أي اتفاقيات تتم بين المستخدمين.
            </p>
